...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname module11) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; Module 11 Binary Trees- Exercises
